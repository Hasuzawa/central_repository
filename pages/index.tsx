  ...
  return (
    <div className={"h-screen w-screen flex flex-col" + getDarkModeClassName("page")}>
      ...
      <main id="main" className=" flex flex-row content-height dark:bg-black dark:text-white">
        ...
        <div id="main-middle" className="flex-none w-screen relative md:w-3/5 lg:w-2/5 h-full">
          <Projects />
        </div>
        <div id="main-right" className="hidden lg:block flex-1 border-l-2 border-black dark:border-white">
          <Introduction />
        </div>
      </main>
